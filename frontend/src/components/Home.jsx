...
const Home = () => {
  return (
    <div
      className="w-full h-auto min-h-[calc(100vh-3.5rem)] flex items-center justify-center text-white px-4 sm:px-6 md:px-8 py-12 relative overflow-hidden"
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-16 max-w-7xl mx-auto w-full items-center">
        <div className="w-full lg:w-1/2 flex flex-col justify-center space-y-8 text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4 items-center sm:items-start justify-center lg:justify-start">
            ...
            <button className="w-fit group border-2 border-gray-600 text-gray-300 px-6 py-3 sm:px-8 sm:py-4 rounded-xl font-semibold text-base sm:text-lg transition-all duration-300 hover:border-purple-400 hover:text-white hover:shadow-lg hover:shadow-purple-500/10 active:scale-95">
              <span className="flex items-center gap-2">Explore Posts</span>
            </button>
          </div>
        </div>
